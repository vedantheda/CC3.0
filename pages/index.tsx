          ...
          <div className="h-[100vh]">
            ...
            <section className="h-[70%] flex flex-col items-center justify-center text-center gap-11 mx-auto">
              ...
              <button
                ...
                className="text-black bg-[#59a4f4] hover:opacity-50 focus:ring-4 focus:outline-none focus:ring-[#050708]/50   font-vanguard font-bold rounded-lg text-lg px-5 py-2.5 text-center inline-flex items-center  mr-2 mb-2 mt-2"
              >
                Register Now!
                <Image
